...
const Skills = () => {
  ...
  >
      ...
      <article>
        <p>
          I build projects with React, Redux, Material-Ui and if a back
          end is needed Firebase. In the past I configured Webpack but now I
        ...
        <p>
          Outside the digital world I host Murder Mysteries and Trivia nights which has made me a
